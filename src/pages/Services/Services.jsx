...
const Services = () => {
  return (
    <div className="container mx-auto pb-20">
      <h1 className="text-4xl font-bold text-center mt-8 text-[#1A2753]">Our Services</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        <div className="bg-white p-6 rounded-lg shadow border-l-8 border-red-500 m-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Customized Feeding Solutions</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow border-l-8 border-red-500 m-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Nutritional Consultation</h2>
          <p className="text-gray-700">
        ...
        <div className="bg-white p-6 rounded-lg shadow border-l-8 border-red-500 m-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Technical Support</h2>
          <p className="text-gray-700">
        ...
        <div className="bg-white p-6 rounded-lg shadow border-l-8 border-red-500 m-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Quality Assurance</h2>
          <p className="text-gray-700">
        ...
        <div className="bg-white p-6 rounded-lg shadow border-l-8 border-red-500 m-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Livestock Management Training</h2>
          <p className="text-gray-700">
        ...
        <div className="bg-white p-6 rounded-lg shadow border-l-8 border-red-500 m-4">
          ...
          <h2 className="text-2xl font-bold mb-4 text-blue-900">Supply Chain Partnership</h2>
          <p className="text-gray-700">
